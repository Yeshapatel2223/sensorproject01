...
from src.constant import CustomException
...
class DataIngestion:
  ...
  def export_collection_as_dataframe(self, collection_name,db_name):
    try:
      ...
      df.replace({'na':np.nan},implace=TRUE) 
      return df
  ...
  def export_data_into_feature_Store_file_path(self)->pd.DataFrame:
    try:
      ...
      os.makedir(raw_path, exist_ok = True)
  ...
  def initiate_data_ingestion(Self) ->path:
    logging.into("enterd initiated_data_ingestion method of data_integration class")
    try:
