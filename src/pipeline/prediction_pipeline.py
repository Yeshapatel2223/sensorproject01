...
class PredictionPipeline:
    ...
    def get_predicted_dataframe(self, input_dataframe_path: str) -> str:
        """Generate prediction CSV with result labels and save output file."""
        try:
            ...
            output_path = os.path.join(
                ...
                self.prediction_pipeline_config.prediction_file_name
            )
    ...
    def run_pipeline(self):
        ...
        try:
            ...
            output_path = self.get_predicted_dataframe(input_csv_path)
            return output_path
